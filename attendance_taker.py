...
class Face_Recognizer:
    ...
    def run(self):
        ...
        cap = cv2.VideoCapture("D:\IU\AI Learning\Projects end to end\Face-Recognition-Based-Attendance-System\data\Test video\LeQ&A with LeBron at #NBAMediaDay 🍿.mp4")
        self.process(cap)
